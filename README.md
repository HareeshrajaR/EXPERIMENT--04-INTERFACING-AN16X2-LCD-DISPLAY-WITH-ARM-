...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
   ...
   Lcd_cursor(&lcd, 0,0);
   Lcd_string(&lcd, "HAREESH R\n");
   Lcd_cursor(&lcd, 1,2);
   Lcd_string(&lcd, "212223230068");
   HAL_Delay(500);
...
## Output screen shots of proteus  :
 ![Screenshot (94)](https://github.com/HareeshrajaR/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870459/c9137057-5b5e-423e-a3bd-aaa075aaf7e3)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot 2024-04-02 105358](https://github.com/HareeshrajaR/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870459/1375e39c-f49b-4620-98f9-91d784a7767d)
